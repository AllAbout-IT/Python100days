...
#
#
# If you want to put many condition in a block.
#
# e.g.
#
...
#   do this
# 
# We can use three options for it.
#
# And   A and B     => They both have to be true. If just one of them is true, say A is true and B is false or A is false and B is true, then the overall thing evaluates to false.
# Or    C or  D     => When you only need one of these condition is true, you can use 'or' instead 'and'. It's only when  both C and D are false, dose this statement actually become false. 
# Not   not   E     => 'not' is the not operator and that this does is it basically reverses a condition.
#
# exercise
# https://replit.com/@appbrewery/day-3-end#main.py
